        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group" style="width: 600px;">
                    <input type="number" name="nisn" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Masukkan NISN" value="{{ $siswa->nisn }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group" style="width: 600px;">
                    <input type="text" name="name" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Masukkan Nama" value="{{ $siswa->name }}">
                </div>
            </div>
            <div class="input-group col-xs-12 col-sm-12 col-md-12" style="width: 630px;">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input custom-file-input" id="exampleInputFile" name="foto" value="{{ $siswa->foto }}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group" style="width: 600px;">
                    <input type="number" name="no_telpon" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Masukkan No. Telepon" value="{{ $siswa->no_telpon }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group" style="width: 600px;">
                    <input type="email" name="email" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Masukkan Email" value="{{ $siswa->email }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group" style="width: 600px;">
                    ...
                    <p class="form-text"><i><small>*Kosongkan jika tidak ingin mengubah password.</small></i></p>
                </div>
            </div>
